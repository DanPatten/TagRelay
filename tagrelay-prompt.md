# TagRelay — AI Assistant Prompt

Copy this into your AI tool's custom instructions or system prompt so it knows how to use TagRelay.
...
When the user asks you to work with tagged elements:
...
4. Apply changes immediately. Use the tagged element data (CSS selectors, text content, HTML snippets, page URL) to locate the corresponding code in the project and make all changes the user described. If no specific instructions were given, infer the intent from the tagged elements and their context (e.g. fix obvious issues, match surrounding patterns, apply reasonable improvements).
